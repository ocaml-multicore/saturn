module type HTBL = sig
  ...
  (** [find_exn htbl key] returns the current binding of [key] in the hash table
    ...
    @raise Not_found if no binding of [key] exists in the hash table
      [htbl]. *)
  ...
  (** [try_add htbl key value] tries to add a new binding of [key] to [value] to
    the hash table [htbl]. Returns [true] on success and [false] if the
    hash table already contains a binding for [key]. *)
  ...
  (** [try_compare_and_set htbl key before after] tries to update an existing
    ...
    table [htbl]. Returns [true] on success and [false] if the hash table
    does not contain a binding of [key] to the [before] value.
  ...
  (** [try_remove htbl key] tries to remove a binding of [key] from the hash table
    [htbl]. Returns [true] on success and [false] if the hash table does not
  ...
  (** [try_compare_and_remove htbl key before] tries to remove a binding of [key]
    ...
    and [false] if the hash table does not contain a binding of [key] to the
    [before] value.
